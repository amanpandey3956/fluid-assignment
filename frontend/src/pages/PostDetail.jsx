    ...
    <div className="post-detail">
      <div className="post-detail-header">
        <Link to="/" className="post-detail-back">
          <HiArrowLeft size={16} /> Back to posts
        </Link>
        ...
        <div className="post-detail-meta">
          <span className="author-chip">By {post.author}</span>
          <span>{timeAgo}</span>
          {wasEdited && <span style={{ color: 'var(--text-muted)' }}>(edited)</span>}
        </div>
      ...
      {showDeleteModal && (
        <ConfirmModal
          ...
          message="This action cannot be undone. All comments will also be deleted."
          emoji="⚠️"
